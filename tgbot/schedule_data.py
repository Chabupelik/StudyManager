...
BASE_SCHEDULE =[
    ...
    # 1 семестр (2026-2027)
    # Понедельник (day: 0)
    {"day": 0, "time": "12:40", "name": "Физическая культура", "teacher": "Сидоров Д.А.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 0, "time": "14:20", "name": "МДК.02.03 Математическое моделирование", "teacher": "Смирнова Л.Н.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 0, "time": "16:00", "name": "МДК.02.02 Инструментальные средства разработки программного обеспечения", "teacher": "Петрушка С.А.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 0, "time": "17:40", "name": "МДК.02.01 Технология разработки программного обеспечения", "teacher": "Петрушка С.А.", "start": "2026-09-01", "end": "2026-12-21"},

    # Вторник (day: 1)
    {"day": 1, "time": "11:20", "name": "Психология общения", "teacher": "Еременко Я.А.", "start": "2026-12-15", "end": "2026-12-15"},
    {"day": 1, "time": "13:10", "name": "Психология общения", "teacher": "Еременко Я.А.", "start": "2026-09-01", "end": "2026-12-13"},
    {"day": 1, "time": "13:10", "name": "Иностранный язык в ПД", "teacher": "Лабинцева Н.Г. / Погребникова Ю.А.", "start": "2026-12-15", "end": "2026-12-15"},
    {"day": 1, "time": "14:50", "name": "Классный час", "teacher": "Сиканова В.А.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 1, "time": "16:00", "name": "МДК.02.02 Инструментальные средства разработки программного обеспечения", "teacher": "Петрушка С.А.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 1, "time": "17:40", "name": "Безопасность жизнедеятельности", "teacher": "Величко С.А.", "start": "2026-09-01", "end": "2026-12-21"},

    # Среда (day: 2)
    {"day": 2, "time": "13:10", "name": "Безопасность жизнедеятельности", "teacher": "Величко С.А.", "start": "2026-09-14", "end": "2026-09-27"},
    {"day": 2, "time": "13:10", "name": "Иностранный язык в ПД", "teacher": "Лабинцева Н.Г. / Погребникова Ю.А.", "start": "2026-12-01", "end": "2026-12-12"},
    {"day": 2, "time": "14:50", "name": "МДК.02.03 Математическое моделирование", "teacher": "Смирнова Л.Н.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 2, "time": "16:40", "name": "МДК.02.02 Инструментальные средства разработки программного обеспечения", "teacher": "Петрушка С.А.", "start": "2026-09-01", "end": "2026-12-21"},

    # Четверг (day: 3)
    {"day": 3, "time": "11:20", "name": "Безопасность жизнедеятельности", "teacher": "Величко С.А.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 3, "time": "13:10", "name": "Численные методы", "teacher": "Сиканова В.А.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 3, "time": "14:50", "name": "МДК.02.03 Математическое моделирование", "teacher": "Смирнова Л.Н.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 3, "time": "16:40", "name": "МДК.02.02 Инструментальные средства разработки программного обеспечения", "teacher": "Петрушка С.А.", "start": "2026-09-01", "end": "2026-12-06"},
    {"day": 3, "time": "16:40", "name": "Основы бережливого производства", "teacher": "Гадаева Д.М.", "start": "2026-12-07", "end": "2026-12-21"},

    # Пятница (day: 4)
    {"day": 4, "time": "09:40", "name": "МДК.02.02 Инструментальные средства разработки программного обеспечения", "teacher": "Петрушка С.А.", "start": "2026-12-07", "end": "2026-12-21"},
    {"day": 4, "time": "11:20", "name": "Основы бережливого производства", "teacher": "Гадаева Д.М.", "start": "2026-12-01", "end": "2026-12-21"},
    {"day": 4, "time": "13:10", "name": "МДК.02.02 Инструментальные средства разработки программного обеспечения", "teacher": "Петрушка С.А.", "start": "2026-09-01", "end": "2026-10-25"},
    {"day": 4, "time": "13:10", "name": "Иностранный язык в ПД", "teacher": "Лабинцева Н.Г. / Погребникова Ю.А.", "start": "2026-11-02", "end": "2026-11-30"},
    {"day": 4, "time": "13:10", "name": "Основы бережливого производства", "teacher": "Гадаева Д.М.", "start": "2026-12-01", "end": "2026-12-21"},
    {"day": 4, "time": "14:50", "name": "МДК.02.01 Технология разработки программного обеспечения", "teacher": "Петрушка С.А.", "start": "2026-09-01", "end": "2026-12-21"},
    {"day": 4, "time": "16:40", "name": "МДК.02.01 Технология разработки программного обеспечения", "teacher": "Петрушка С.А.", "start": "2026-09-01", "end": "2026-12-21"},
]
